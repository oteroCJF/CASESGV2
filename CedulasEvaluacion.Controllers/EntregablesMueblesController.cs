...
namespace CedulasEvaluacion.Controllers
{
    public class EntregablesMueblesController : Controller
    {
        ...
        public EntregablesMueblesController(IRepositorioEntregablesCedula iVEntregables, IRepositorioEvaluacionServicios iCedula, IHostingEnvironment environment)
        {
        ...
        [HttpGet]
        [Route("/muebles/getEntregables/{id?}/{servicio}")]
        public async Task<IActionResult> getEntregablesMuebles(int id,int servicio)
        {
        ...
        [HttpGet]
        [Route("/muebles/getListadoEntregables/{id?}/{servicio}")]
        public async Task<IActionResult> getListadoEntregablesMuebles(int id,int servicio)
        {
