...
namespace CedulasEvaluacion.Controllers
{
    public class EntregablesCelularController: Controller
    {
        ...
        public EntregablesCelularController(IRepositorioEntregablesCedula iVEntregables, IRepositorioEvaluacionServicios iCedula, IHostingEnvironment environment)
        {
        ...
        [HttpGet]
        [Route("/telCelular/getEntregables/{id?}/{servicio}")]
        ...
        [HttpGet]
        [Route("/telCelular/getListadoEntregables/{id?}/{servicio}")]
